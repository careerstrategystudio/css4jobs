...
const translations = {
  es: {
    ...
    feat3_title: 'Búsqueda Global de Trabajo',
    ...
    test1_text: 'En 2 minutos tenía un CV adaptado para Google. Conseguí la entrevista en menos de una semana.',
    test1_name: 'María García',
    test1_role: 'Software Engineer · Dublin',
    test2_text: 'Mi LinkedIn pasó de 5 a 50 visitas semanales de reclutadores. Increíble herramienta.',
    test2_name: 'Carlos Ruiz',
    test2_role: 'Sales Manager · Londres',
    test3_text: 'La adaptación de CV es brutalmente buena. Diferente a todo lo que había probado antes.',
    test3_name: 'Ana Martínez',
    test3_role: 'Data Analyst · Amsterdam',

    // CTA Banner
    cta_h2: '¿Listo para conseguir más entrevistas?',
    cta_sub: 'Adaptá tu primer CV gratis. Sin tarjeta de crédito. Sin registros.',
    cta_btn: 'Empezar gratis ahora',

    // CV page
    cv_badge: 'Adaptación de CV · con Claude AI',
    cv_h1: 'Adaptá tu CV con IA',
    ...
    pr_sub: 'Empezá gratis. Pasá a Pro cuando estés listo para escalar tu búsqueda.',
    pr_period: '/mes',
    ...
    pr_pro_f2: 'Análisis de LinkedIn ilimitados',
    pr_pro_f3: 'Exportar en PDF y Word',
    pr_pro_f4: 'Job Search Global (próximamente)',
    pr_pro_f5: 'Análisis ATS detallado',
    ...
    pr_teams_f5: 'Integración con ATS',
    pr_teams_f6: 'Soporte dedicado 24/7',
    // Tools section
    pr_tools_title: 'Herramientas incluidas en CSS 4 JOBS',
    pr_tool1: 'Adaptación de CV con IA',
    pr_tool2: 'LinkedIn Optimizer',
    pr_tool3: 'Búsqueda Global de Trabajo',
    pr_soon: 'Próximamente',
    // Testimonials section
    pr_test_title: 'Usuarios que ya consiguieron entrevistas',
    pr_t1: 'Conseguí entrevista en Zalando a la semana de usar CSS 4 JOBS. La adaptación de CV es increíble.',
    pr_t1_name: 'Laura Sánchez',
    pr_t1_role: 'UX Designer · Berlín',
    pr_t2: 'Mi LinkedIn pasó de 3 a 60+ visitas semanales de reclutadores. Brutal.',
    pr_t2_name: 'Martín López',
    pr_t2_role: 'Backend Engineer · Dublin',
    pr_t3: 'La IA entiende perfectamente qué keywords necesita cada trabajo. Vale cada euro.',
    ...
    pr_faq_a1: 'Sí. No hay contratos ni permanencia. Cancelás cuando quieras desde tu cuenta.',
    pr_faq_q2: '¿Cómo se procesa el pago?',
    pr_faq_a2: 'Usamos Revolut para procesar los pagos de forma segura. Aceptamos tarjetas de crédito y débito.',
    pr_faq_q3: '¿Qué idiomas soporta la IA?',
    pr_faq_a3: 'Español, inglés y portugués. Podés adaptar tu CV en cualquiera de estos idiomas.',
    pr_faq_q4: '¿La IA inventa información?',
    pr_faq_a4: 'No. La IA reorganiza y optimiza tu información real. Nunca agrega experiencia o habilidades que no tenés.',
    pr_faq_q5: '¿Funciona para cualquier industria?',
    pr_faq_a5: 'Sí. La IA está entrenada para optimizar CVs y perfiles de LinkedIn en cualquier sector: tech, ventas, marketing, finanzas, salud, y más.',
    // CTA
    pr_cta_h2: '¿Todavía no convencido?',
    pr_cta_sub: 'Probalo gratis — sin tarjeta de crédito. Adaptá tu primer CV hoy.',
